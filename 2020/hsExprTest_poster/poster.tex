...
\begin{block}{More Information}
    ...
    \bigskip\bigskip
    More information and links to GitHub can also be found on the accompanying
...
\begin{block}{Input Specification}
  ...
  In the future, we plan to auto-create generators for recursive data types with no dependency between values (like \hs{BinTree}).
\end{block}
