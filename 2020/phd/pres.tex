...
\begin{frame}{DIVINE}
  \textbf{all contributions presented in the thesis are implemented and evaluated in DIVINE}
  ...
  \begin{itemize}
    ...
    \item primarily targets safety
      \begin{itemize}
        ...
        \item also supports Büchi and termination conditions
      \end{itemize} \pause
...
\begin{frame}{Exceptions in DIVINE}
  ...
  \begin{itemize}
    \item make the analyser core aware of exceptions?
    \item adapt library to read information from analyser?
    \item re-use big parts of existing library support?
    \item the last option not considered, or deemed impractical by related work
  \end{itemize}
  \pause
...
\begin{frame}{Beyond Safety Checking}
  ...
  \bigskip
  → termination checking is necessary
  \begin{itemize}
